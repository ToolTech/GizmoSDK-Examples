...
INCLUDES = /I "..\..\include" /I "$(QTDIR)\include"
...
LIBS ="..\..\lib\gzsystem.lib" \
	...
	"..\..\lib\gzimage.lib" \
    "..\..\lib\gzbase.lib"  \
    "$(QTDIR)\lib\qt210.lib" "$(QTDIR)\lib\qtmain.lib" 
...
debug:
    -@echo CPPOPTS = /nologo /MT /W3 /Gm /GX /ZI /Od /D "QT_DLL" /D "GZ_DLL" /D "_DEBUG" /D "GZ_OPENGL" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "GZ_DEBUG" /YX /FD /GZ /c > winbuildflags
...
release:
    -@echo CPPOPTS = /nologo /MT /W3 /GX /O2 /D "QT_DLL" /D "NDEBUG" /D "GZ_DLL" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "GZ_OPENGL" /YX /FD /c > winbuildflags
