...
debug:
        -@echo CPPOPTS = /nologo /MD /W3 /Gm /GX /ZI /Od /D "_DEBUG" /D "GZ_OPENGL" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "GZ_DEBUG" /YX /FD /GZ /c > winbuildflags
	-@echo LINKFLAGS = opengl32.lib netapi32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:yes /debug /machine:I386  /out:"$(NAME).exe" /pdbtype:sept >> winbuildflags
...
release:
        -@echo CPPOPTS = /nologo /MD /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "GZ_OPENGL" /YX /FD /c > winbuildflags
